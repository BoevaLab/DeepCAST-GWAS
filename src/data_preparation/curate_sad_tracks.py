...
from config import DATA_DIR, DEEPCAST_DIR, TRACKLISTS_DIR

file = DATA_DIR / "target_dnase_ataq_tracks_labelled.csv"
...
def generate_sad_tracks(index, phenotype, trait_type=None, category=None, explanation=None, model="gpt-4o", perform_lookup=True, perform_union=True):
    ...
    dir_path = TRACKLISTS_DIR / 'intermediate_files/test' # TODO change back
    if(is_4o):
    ...
    load_dotenv(Path(DEEPCAST_DIR) / "src/.env")
